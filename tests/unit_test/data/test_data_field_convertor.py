...
BASE_PARAMS_SELECT_FROM_LIST = {
    ...
    'conversion_rule': {
        ...
        'actions': [
            {'select_object_from_list': ['selector', 2]}
        ]
    }
}
...
PARAMS_SELECT_FROM_LIST_VALUE_NOT_FOUND = {
    ...
    'conversion_rule': {
        'fieldname': 'list_key_name',
        'actions': [
            {'select_object_from_list': ['selector', 3]}
        ]
    }
}
...
PARAMS_COUNTRY_CODE_FROM_PHONE_NUMBER = {
    ...
    'conversion_rule': {
        ...
        'actions': [
            {'get_country_code_from_phone_nr': 'phonenumber'}
        ]
    }
}
...
PARAMS_ADD_VALUE_FROM_FIELD = {
    ...
    'conversion_rule': {
        'fieldname': 'to_field',
        'actions': [
            {'add_value_from_field': 'from_field'}
        ]
    }
}
...
PARAMS_ADD_KEY_VALUE_FROM_FIELD = {
    ...
    'conversion_rule': {
        'fieldname': 'to_field',
        'actions': [
            {'add_key_value_from_field': 'from_field'}
        ]
    }
}

PARAMS_ADD_DATA_FROM_DICT = {
    'record': {'from_field': {'abc': {'1': 1, '2': 2}},
               'to_field': {'0': 0}},
    'conversion_rule': {
        'fieldname': 'to_field',
        'actions': [
            {'add_data_from_dict': 'from_field.abc'}
        ]
    }
}
...
PARAMS_ADD_KEY_VALUE_FROM_FIELD2 = {
    ...
    'conversion_rule': {
        'fieldname': 'to_field',
        'actions': [
            {'add_key_value_from_field': ['from_field', 'field2']}
        ]
    }
}
...
PARAMS_ADD_VALUE_FROM_NETSED_FIELD = {
    ...
    'conversion_rule': {
        'fieldname': 'to_field',
        'actions': [
            {'add_value_from_field': 'from_field.nested'}
        ]
    }
}
...
PARAMS_CHANGE_KEY_NAME_NESTED = {
    ...
    'conversion_rule': {
        ...
        'actions': [
            {'change_key_name_to': 'parent_field.new_nested'}
        ]
    }
}
