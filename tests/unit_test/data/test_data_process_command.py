from record_converter.abstract import AbstractCommand
...
PARAMS_ADD_COMMANDS = {
    ...
    'add_process_commands': {
        'reverse': GetReverseTest
    }
...
PARAMS_TO_LIST_DYNAMIC = {
    'record': {
        'field1': '10.000 eur',
        'field2': {'nested_field': '9.000 eur'}
    },
    'record_convertor': ConvertRecordTest,
    'process_command': '$to_list_dynamic',
    'process_args': [
        {'price1': 'field1'},
        {'price2': 'field2.nested_field'}]
}

PARAMS_FIRST_ITEM_FROM_LIST = {
    'record': {
        'field1': [
            {'field2': 'item1'}, {'field2': 'item2'}, {'field2': 'item3'}]
    },
    'record_convertor': ConvertRecordTest,
    'process_command': '$first_item_from_list',
    'process_args': {
        'list_field_name': 'field1',
        'result': 'field2'
    }
}
